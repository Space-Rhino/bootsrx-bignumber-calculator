 ...
 *
 * <p>Button for each digit 0 through 9. (requirement 3.1.3)
 *
 * <p>Button for sign-toggle. (requirement 3.1.2)
 *
 * <p>Button for decimal. (requirement 3.1.5)
 *
 * <p>Standard window buttons. (requirement 3.1.6)
 *
 * <p>Buttons for clear all, clear, and delete functions. (requirement 3.1.7)
 *
 * <p>Buttons for arithmetic operators. (requirement 3.1.8)
 *
 * <p>Buttons for pi, square root, square, and inverse. (requirement 3.1.9)
 *
 * @author Shawn Crahen
 * @version 1.0
 * @see JPanel
...
public class ButtonPanel extends JPanel {
  ...
  /**
   * This class implements a handler for ActionEvents that correspond to digit entries. (requirement
   * 3.2.1)
   *
   * @author Shawn Crahen
   * @version 1.0
  ...
  /**
   * This class implements a handler for ActionEvents that correspond to operation entries.
   * (requirement 3.2.1)
   *
   * @author Shawn Crahen
   * @version 1.0
  ...
  class OperationHandler implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
      ...
      if ((action.equals("AC") || action.equals("=")) && activeOperationButton != null) {
