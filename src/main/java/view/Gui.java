...
/**
 * This class is the main view class and configures the layout and functionality of the main window
 * frame. This class passes events to the Presenter.
 *
 * @author Shawn Crahen
 * @version 1.0
 * @see JFrame
...
public class Gui extends JFrame {
  ...
  /**
   * This class handles KeyEvents enabling users to enter input with keyboard keys. (requirement
   * 3.2.2)
   *
   * @author Shawn Crahen
   * @version 1.0
