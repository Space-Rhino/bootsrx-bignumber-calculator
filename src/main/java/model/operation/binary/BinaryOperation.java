...
/**
 * This class provides a skeletal implementation of a generic binary operation. To implement a
 * binary operation, extend this class and override the executeBinary(Number, Number) method.
 *
 * @author Shawn Crahen
 * @version 1.0
 * @see Operation
...
public abstract class BinaryOperation extends Operation {
   ...
   *
   * <p>Calls executeBinary(Number, Number), pushes the result back to the operand stack, then
   * updates the display.
   *
   * <p>If executeBinary(Number, Number) throws and ArithmeticException, updates display indicating
