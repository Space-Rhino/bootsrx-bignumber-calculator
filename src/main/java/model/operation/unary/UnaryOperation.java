 ...
 * To implement a unary operation, extend this class and override the
...
public abstract class UnaryOperation extends Operation {
	 ...
	 * <p>
	 * Calls executeUnary(Number), pushes the result back to the operand stack, then
	 * updates the display.
	 * <p>
	 * If executeUnary(Number) throws an ArithmeticException, updates display
