...
/**
 * This class represents the display register for this Calculator. It maintains the display value
 * and fires a PropertyChangeEvent when the value changes.
 *
 * @author Shawn Crahen
 * @version 1.0
...
public class Display {
  ...
  /**
   * Sets the value of the display register to the given String and fires a PropertyChangeEvent to
   * listeners.
   *
  ...
  /**
   * Appends the next digit to the display register. Enforces maximum length, prevents subsequent
   * decimal entries.
   *
